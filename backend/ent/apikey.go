...
type APIKey struct {
	...
	// Key source: user-created keys are visible; internal keys are hidden from user key management
...
func (*APIKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case apikey.FieldKey, apikey.FieldName, apikey.FieldSource, apikey.FieldStatus:
